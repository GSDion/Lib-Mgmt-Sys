...
import java.awt.*;
public class ViewUserReturnedBooksFrame extends JFrame {
    ...
    public ViewUserReturnedBooksFrame(String UID, String username, String userType) {
    ...
    public void initComponents(String UID, String username) {
         ...
         setTitle("LMS User - View Retruned Books");
         setSize(1200, 700);
         ...
         JLabel titleLabel = new JLabel("User Dashboard - View Returned Books", SwingConstants.LEFT);
        ...
        Object[][] data = DatabaseHelper.retrieveTableDataByUID("returned_books", columnNames, UID);
