...
public class IssuedBooksFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("Admin Dashboard - View Issued Books", SwingConstants.LEFT);
        ...
        Object[][] data = DatabaseHelper.retrieveTableData("issued_books", columnNames);
