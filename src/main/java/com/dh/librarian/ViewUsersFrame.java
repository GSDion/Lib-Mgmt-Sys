...
public class ViewUsersFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("Admin Dashboard - View Users", SwingConstants.LEFT);
        titleLabel.setFont(new Font("Arial", Font.PLAIN, 24));
        titleLabel.setForeground(Color.DARK_GRAY);
    
        JLabel breadcrumbLabel = new JLabel("Home > View Users", SwingConstants.RIGHT);
        ...
        // Table columns
        String[] columnNames = {"uid", "username", "password", "user_type"};

        // Fetch data from the database
        Object[][] data = DatabaseHelper.retrieveTableData("users", columnNames);
